#!/usr/bin/env bash
# Preserve unsubmitted v2 copies after re-review and create the active v3 materialization.
set -euo pipefail
...
mv "${PREFLIGHT_DIR}/source_manifest.sha256" "${PREFLIGHT_DIR}/source_manifest_v2.sha256"
